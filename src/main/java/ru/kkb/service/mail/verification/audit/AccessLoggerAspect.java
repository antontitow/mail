package ru.kkb.service.mail.verification.audit;
...
public class AccessLoggerAspect {
    ...
    @Pointcut("execution(* ru.kkb.service.mail.verification.controller.*.*(..)) || " +
            "execution(* ru.kkb.service.mail.verification.*.*.*(..))")
